...
- `/sc:build --api` - API design and backend build optimization
- `/sc:git` - Version control and deployment workflows
...
- `/sc:analyze` - Systematic, evidence-based analysis
- `/sc:troubleshoot` - Root cause identification
- `/sc:explain --detailed` - Comprehensive explanations with evidence
...
- `/sc:analyze --focus security` - Security-focused system analysis
- `/sc:improve --security` - Security hardening and vulnerability remediation
...
- `/sc:explain` - Comprehensive educational explanations
- `/sc:document` - Educational documentation and guides
- `/sc:index` - Navigate and understand complex systems
